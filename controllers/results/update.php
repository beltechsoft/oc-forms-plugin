<?php Block::put('breadcrumb') ?>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><?php echo __('beltechsoft.forms::lang.controller.updating')?></li>
    </ol>
<?php Block::endPut() ?>
    ...
    <?= Form::open(['class' => 'layout']) ?>
        ...
        <div class="form-buttons">
            <div class="loading-indicator-container">
                ...
                <span class="btn-text">
                    <?= e(trans('backend::lang.form.or')) ?> <a href="<?= Backend::url('beltechsoft/forms/results') ?>"><?= e(trans('backend::lang.form.cancel')) ?></a>
                </span>
            </div>
        </div>
